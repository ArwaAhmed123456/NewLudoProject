...
struct ScoreLog ScoreA=(struct ScoreLog){0,0,0};
struct ScoreLog ScoreB=(struct ScoreLog){0,0,0};
struct ScoreLog ScoreC=(struct ScoreLog){0,0,0};
struct ScoreLog ScoreD=(struct ScoreLog){0,0,0};
...
void initializePlayerArgs()
{
    for (int i = 0; i < 4; i++)
    {
        tokenA[i] = (struct PlayerArgs){&currPositionA[i], tokenCharA[i], &tempA[i], &tokenTowerPositionA[i]};
        tokenB[i] = (struct PlayerArgs){&currPositionB[i], tokenCharB[i], &tempB[i], &tokenTowerPositionB[i]};
        tokenC[i] = (struct PlayerArgs){&currPositionC[i], tokenCharC[i], &tempC[i], &tokenTowerPositionC[i]};
        tokenD[i] = (struct PlayerArgs){&currPositionD[i], tokenCharD[i], &tempD[i], &tokenTowerPositionD[i]};
    }
}
...
int tokenkill(int newRow, int newCol, int tokenChar)
{
    ...
    if (scc = samecolorcheck(grid[newRow][newCol], tokenChar, newRow, newCol))
    {
        ...
        {return *(tokenB[0].tokenTowerPosition)+1;}
        ...
        {return *(tokenC[0].tokenTowerPosition)+1;}
        ...
        {return *(tokenD[0].tokenTowerPosition)+1;}
        ...
        {return *(tokenA[1].tokenTowerPosition)+1;}
        ...
        {return *(tokenB[1].tokenTowerPosition)+1;}
        ...
        {return *(tokenC[1].tokenTowerPosition)+1;}
        ...
        {return *(tokenD[1].tokenTowerPosition)+1;}
        ...
        {return *(tokenA[2].tokenTowerPosition)+1;}
        ...
        {return *(tokenB[2].tokenTowerPosition)+1;}
        ...
        {return *(tokenC[2].tokenTowerPosition)+1;}
        ...
        {return *(tokenD[2].tokenTowerPosition)+1;}
        ...
        {return *(tokenA[3].tokenTowerPosition)+1;}
        ...
        {return *(tokenB[3].tokenTowerPosition)+1;}
        ...
        {return *(tokenC[3].tokenTowerPosition)+1;}
        ...
        {return *(tokenD[3].tokenTowerPosition)+1;}
